...
void FILTRE::average() {
    if (!reset_n) {
        ...
        h_out = false;
        v_out = false;
    } else if (h_in && pixel_received_i < WIDTH+1) { // Première ligne de pixels + premier pixel de la première cologne
        ...
        else if (pixel_computed_i == HEIGHT*WIDTH-1) // pixel en bas à droite
        {
